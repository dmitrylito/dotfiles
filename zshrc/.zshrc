...
ZSH_CUSTOM="$HOME/.oh-my-zsh-custom/custom/"
...
plugins=(git github zsh-autosuggestions zsh-autocomplete zsh-navigation-tools tailscale) 
...
# Prompt: literal "~" always, then username@hostname dir
# username blue, hostname green, dir cyan; git shows as [branch], + for s$
#PROMPT='%F{blue}%n%f@%F{green}%m%f %F{cyan}%~%f${vcs_info_msg_0_} %# '
